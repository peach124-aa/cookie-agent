...
def deserialize_from_dict[T](cls: type[T], data: dict[str, Any]) -> T:
    ...
    for field in fields(cls):
        ...
        if name in data:
            ...
            # Simplified generic unwrapping: if the field type is an Optional
            # or Union, this basic serializer expects the structure to match
            # the primary type if it's a dataclass.
            ...
            # For strictness in config, we assume fields that are dicts map
            # to dataclasses.
            try:
            ...
            # Missing fields should either trigger default factories
            # or fail natively on instantiation
            pass
