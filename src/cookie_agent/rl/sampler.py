...
class MiniBatchSampler[StateType, ActionType, InfoType]:
    ...
    def __init__(
        ...
        Raises:
            ReplayBufferError: If batch_size is less than 1.
        """
        if batch_size < 1:
            raise ReplayBufferError("batch_size must be at least 1.")
    ...
    def __iter__(self) -> Iterator[list[Experience[StateType, ActionType, InfoType]]]:
        ...
        Yields:
            A list of generic experiences. The last batch may be smaller
            than batch_size.
        """
